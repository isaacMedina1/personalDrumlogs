...
Sun 19. Trying different ostinatos for jazz comping (comp ex. `~ ~ s . ~ ~ s . ~ ~ s . ~ s s`). Use the _strudel_ window to transcribe the rhythms on the table.

<strudel-repl id="ride-transp">
  <!--/*transpositions of ride pattern for jazz coordination developement*/
s(`<[hh ~ ~] [hh ~ hh] [hh ~ ~] [hh ~ hh]>`).bank("RolandTR808")
.fast(3)
.gain(0.8)
  -->
  </strudel-repl>
