...
\addcontentsline{toc}{subsection}{Mai}
...
\addcontentsline{toc}{subsection}{Dezember}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4157}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5843}}@{}}
\toprule\noalign{}
...
\addcontentsline{toc}{subsection}{August}
...
\addcontentsline{toc}{subsection}{Juli}
...
\addcontentsline{toc}{subsection}{Juni}
...
\phantomsection\label{jun262023}
...
\addcontentsline{toc}{subsection}{April}
...
\addcontentsline{toc}{subsection}{März}
...
\addcontentsline{toc}{subsection}{Februar}
...
\addcontentsline{toc}{subsection}{Januar}
...
\phantomsection\label{okt152022}
...
\phantomsection\label{okt112022}
