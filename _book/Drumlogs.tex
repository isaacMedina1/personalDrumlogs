...
\section*{September 2023}\label{september-2023}}
\addcontentsline{toc}{section}{September 2023}

Do 14. \emph{Escritura}, instalé el Plugin \href{https://blechtrottel.net/en/abc_impex.html}{ABC\_ImpExp} para Musescore. Hay algunos parámetros que me parecen sobrados al transformar un ritmo a notación ABC, aquí una pequeña lista.
...
\tightlist
\item
  M: 4/4 -\textgreater{} M: C
\item
  V:1 perc nm=``Piano, Central Stage Kit - Pattern 1'' snm=``Pno.'' -\textgreater{} V:1 perc nm=``Drums'' style=x
\item
  V:2 perc -\textgreater{} V:2 perc style=normal
\item
...
\section*{August 2023}\label{august-2023}}
\addcontentsline{toc}{section}{August 2023}

Di 15. \emph{Drum Techniques of Led Zeppelin}, Black Dog, first lecture and Fill on Bar 32 practice.

Mi 09. \emph{Paradiddle Johnie}, bars 1-24, Snare + accents on Jam Block.
